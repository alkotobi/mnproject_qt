...
int main(int argc, char *argv[]) {
    ...
    bool ret = sql =="create table nour ( id serial primary key, integer_field integer, text_field text, real_field real, varchar_field varchar(255), bool_field bool, timestamp_field timestamp );";
